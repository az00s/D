    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    {
                        //if ((string)Session["User"] == model.Email)
                        //{
                        //    if ((string)System.Web.HttpContext.Current.Session["UserAgent"] != Request.UserAgent || (string)Session["IP"] != Request.UserHostAddress)
                        ...
                        //    Session.Add("User", model.Email);
                        //    Session.Add("IP",HttpContext.Request.UserHostAddress);
                        //    Session.Add("UserAgent", HttpContext.Request.UserAgent);
                        //    return RedirectToLocal(returnUrl);
                        //}
